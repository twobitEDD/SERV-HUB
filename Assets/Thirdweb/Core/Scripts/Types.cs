...
namespace Thirdweb
{
    ...
    [System.Serializable]
    public struct ValidatorMetadata
    {
        ...
        public ValidatorDescription description;
        public string unbonding_height;
        public string unbonding_time;
        public Commission commission;
        public string min_self_delegation;
        public string unbonding_on_hold_ref_count;
        public List<object> unbonding_ids; // Change the type as needed
        ...
        public override string ToString()
        {
            return $"ValidatorMetadata:\n" +
                   ...
                   $"Status: {status}\n" +
                   $"Tokens: {tokens}\n" +
                   $"Delegator Shares: {delegator_shares}\n" +
                   $"Unbonding Height: {unbonding_height}\n" +
                   $"Unbonding Time: {unbonding_time}\n" +
                   $"Min Self Delegation: {min_self_delegation}\n" +
                   $"Unbonding On Hold Ref Count: {unbonding_on_hold_ref_count}\n" +
    ...
    [System.Serializable]
    public struct ValidatorList
    {
        public Validator[] validators;
    }

    [System.Serializable]
    public class ConsensusPubKey
    {
        public string type;
        public string key;
    }
    ...
    public class ValidatorDescription
    {
        ...
        public string security_contact;
    ...
    {
        public CommissionRates commission_rates;
